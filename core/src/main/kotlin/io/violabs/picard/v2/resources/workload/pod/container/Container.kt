...
data class Container(
     ...
     * Pod's lifecycle, when it might take a long time to load data or warm a cache,
     ...
     * across multiple attach sessions.
     ...
     * open and accepts data until the client disconnects, at which time stdin is
     * closed and remains closed until the container is restarted.
     ...
     * For non-init containers or when this field is not specified, the restart behavior is
