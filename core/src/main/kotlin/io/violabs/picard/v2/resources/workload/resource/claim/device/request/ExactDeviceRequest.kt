...
data class ExactDeviceRequest(
     ...
     * Claims with AdminAccess are expected to be used for monitoring or other management services 
     * for a device. They ignore all ordinary claims to the device with respect to access modes 
     * and any resource allocations.
     * 
     ...
     * on the node for the allocation to succeed. Allocation will fail if some devices are already allocated, 
     * unless adminAccess is requested.
     * 
     * If AllocationMode is not specified, the default mode is ExactCount. If the mode is ExactCount 
     * and count is not specified, the default count is one. Any other requests must specify this field.
     * 
     ...
     * to be considered for this request. All selectors must be satisfied for a device to be considered.
     * 
