...
data class MatchCondition(
     ...
     * CEL expressions have access to the contents of the AdmissionRequest and Authorizer, organized
     * into CEL variables:
     *
     ...
     * (user or service account) of the request. See https://pkg.go.dev/k8s.io/apiserver/pkg/cel/library#Authz
     * 'authorizer.requestResource' - A CEL ResourceCheck constructed from the 'authorizer' and
     * configured with the request resource. Documentation on CEL: https://kubernetes.io/docs/reference/using-api/cel/
     *
     * Required.
     */
     ...
     * as well as providing an identifier for logging purposes. A good name should be descriptive
     * of the associated expression. Name must be a qualified name consisting of alphanumeric
