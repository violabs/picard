...
data class PriorityLevelConfigurationSpec(
     ...
     * (and thus are never queued) and do not detract from the capacity made available to other priority levels.
     * A value of "Limited" means that (a) requests of this priority level are subject to limits and 
