...
class EndpointSliceTest : SuccessBuildSim<EndpointSliceV2, EndpointSliceV2DslBuilder>() {
    companion object {
        @JvmStatic
        @BeforeAll
        ...
        private val SUCCESS_POSSIBILITIES = possibilities<EndpointSliceV2, EndpointSliceV2DslBuilder> {
            scenario {
                id = "minimum"
