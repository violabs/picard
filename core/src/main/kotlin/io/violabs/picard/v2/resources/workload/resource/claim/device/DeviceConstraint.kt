...
data class DeviceConstraint(
    /**
     * MatchAttribute requires that all devices in question have this attribute and that its type 
     * and value are the same across those devices.
     * 
     ...
     * because that is part of its specification, but if one device doesn't, then it also will not be chosen.
     * 
