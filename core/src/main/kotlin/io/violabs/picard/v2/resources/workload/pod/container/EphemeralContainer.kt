...
data class EphemeralContainer(
    ...
    /**
     * If set, the name of the container from PodSpec that this ephemeral container targets. The ephemeral container will be run in the same process namespace as this container.
     */
