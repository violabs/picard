...
data class LimitedPriorityLevelConfiguration(
    /**
     * borrowingLimitPercent, if present, configures a limit on how many seats this priority level can borrow 
     * from other priority levels. The limit is known as this level's BorrowingConcurrencyLimit (BorrowingCL) 
     * and is a limit on the total number of seats that this level may borrow at any one time.
     ...
     * that is greater than its own nominal concurrency limit (NominalCL). 
     ...
     * The number of seats that other levels can borrow from this level, known as this level's LendableConcurrencyLimit (LendableCL),
     ...
     * This is the number of execution seats available at this priority level. This is used both for requests dispatched 
     * from this priority level as well as requests dispatched from other priority levels borrowing seats from this level.
