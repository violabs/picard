...
data class AuditAnnotation(
     ...
     * and the same audit annotation key, the annotation key will be identical. In this case, 
     * the first annotation written with the key will be included in the audit event and all 
     ...
     * audit annotation value. The expression must evaluate to either a string or null value. 
     * If the expression evaluates to a string, the audit annotation is included with the 
     * string value. If the expression evaluates to null or empty string the audit annotation 
     * will be omitted. The valueExpression may be no longer than 5kb in length. If the 
     * result of the valueExpression is more than 10kb in length, it will be truncated to 10kb.
     *
