...
data class CustomResourceDefinitionSpec(
     ...
     */
    val names: CustomResourceDefinitionNames? = null,
    /**
     ...
     * which are ordered lexicographically. "Kube-like" versions start with a "v", then are followed by 
     * a number (the major version), then optionally the string "alpha" or "beta" and another number 
     ...
     */
    val versions: List<CustomResourceDefinitionVersion>? = null,
    /**
     ...
     * metadata are always preserved. This field is deprecated in favor of setting x-preserve-unknown-fields 
