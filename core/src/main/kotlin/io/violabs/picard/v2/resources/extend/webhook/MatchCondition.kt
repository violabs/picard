...
data class MatchCondition(
     ...
     * of the associated expression. Name must be a qualified name consisting of alphanumeric characters,
     * '-', '_' or '.', and must start and end with an alphanumeric character (e.g. 'MyName',
     * or 'my.name', or '123-abc', regex used for validation is '([A-Za-z0-9][-A-Za-z0-9_.]*)
