...
data class PodStatus(
    ...
    /**
     * podIPs holds the IP addresses allocated to the pod. If this field is specified, the 0th entry must match the podIP field. This list is empty if no IPs have been allocated yet.
     */
