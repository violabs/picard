...
data class EndpointPort(
     ...
     * Kubernetes service, this must be set to the service's target port. EndpointSlices used for 
     * other purposes may have a nil port.
     */
    val port: Int? = null,
    /**
     ...
     * If the EndpointSlice is derived from a Kubernetes service, this corresponds to the 
     ...
     * richer behavior for protocols that they understand. This field follows standard Kubernetes 
