...
import io.violabs.picard.dsl.process.propSchema.DefaultPropertySchemaService
import io.violabs.picard.dsl.schema.DslPropSchema
import io.violabs.picard.dsl.utils.VLoggable
import io.violabs.picard.dsl.utils.isGroupDsl
import io.violabs.picard.dsl.utils.mapGroupType
    ...
    private fun generateFilesForDsl(
        ...
        val fileSpec = kotlinPoet {
            file {
                ...
                addImportIf(hasCollectionRequireNotEmpty, "io.violabs.picard.dsl", "vRequireCollectionNotEmpty")
                addImportIf(hasMapRequireNotEmpty, "io.violabs.picard.dsl", "vRequireMapNotEmpty")
