...
class Frontend(
     ...
     */
    val logQueriesLongerThan: Duration? = null,
    /**
     ...
     */
    val logQueryRequestHeaders: String? = null,
    /**
     ...
     */
    val schedulerDNSLookupPeriod: Duration? = null,
    /**
     * # Number of concurrent workers forwarding queries to single query-scheduler.
     * # CLI flag: -frontend.scheduler-worker-concurrency
     * [scheduler_worker_concurrency: <int> | default = 5]
     */
    val schedulerWorkerConcurrency: Int? = null,
    /**
     ...
     */
    val compressResponses: Boolean? = null,
    /**
     ...
     */
    val supportParquetEncoding: Boolean? = null
)