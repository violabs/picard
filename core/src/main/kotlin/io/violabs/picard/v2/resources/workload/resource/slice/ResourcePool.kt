...
data class ResourcePool(
     ...
     * fine for consumers, assuming that all ResourceSlices in a pool are updated 
     * to match or deleted.
     * 
     * Combined with ResourceSliceCount, this mechanism enables consumers to detect 
     * pools which are comprised of multiple ResourceSlices and are in an incomplete state.
     */
    val generation: Long,
    /**
     ...
     * 
     * It must not be longer than 253 characters and must consist of one or more 
     * DNS sub-domains separated by slashes. This field is immutable.
     */
    val name: String,
    /**
