 ...
 * For the PostStart and PreStop lifecycle handlers, management of the container blocks
...
data class Lifecycle(
     ...
     * request or management event such as liveness/startup probe failure, preemption, resource contention, etc.
