...
import io.violabs.picard.v2.resources.workload.pod.hostalias.HostAlias
...
data class PodSpec(
     ...
     *
     * SchedulingGates can only be set at pod creation time, and can only be removed by clearing the schedulingGates field from the pod spec.
     *
