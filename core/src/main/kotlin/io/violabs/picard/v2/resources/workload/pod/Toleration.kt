...
data class Toleration(
    ...
    enum class Operator {
        /**
         * Exists is a wildcard operator that matches all values for the key.
         */
        Exists,
    ...
    enum class Effect {
        /**
         * NoSchedule means that the pod will not be scheduled onto a node
         * if it has a matching taint.
         */
        NoSchedule,

        /**
         * PreferNoSchedule means that the pod will prefer not to be scheduled
         * onto a node with a matching taint, but it is not guaranteed.
         */
        PreferNoSchedule,

        /**
         * NoExecute means that the pod will be evicted from a node if it has
         * a matching taint.
         */
        NoExecute
    }
